...
//	                .must(new ScriptQueryBuilder(script1))
			...
			aggregation.subAggregation(AggregationBuilders.terms("ss_store_s_store_id")
		        			...
		        			.order(BucketOrder.compound(
			        					BucketOrder.aggregation("sun_sales", true),
			        					BucketOrder.aggregation("mon_sales", true),
			        					BucketOrder.aggregation("tue_sales", true),
			        					BucketOrder.aggregation("wed_sales", true),
			        					BucketOrder.aggregation("thu_sales", true),
			        					BucketOrder.aggregation("fri_sales", true),
			        					BucketOrder.aggregation("sat_sales", true)))
