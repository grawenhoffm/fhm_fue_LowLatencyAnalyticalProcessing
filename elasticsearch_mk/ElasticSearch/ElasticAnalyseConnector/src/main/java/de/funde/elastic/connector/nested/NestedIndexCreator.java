 ...
 *
 */
public class NestedIndexCreator implements IndexCreator {

	private static final Logger LOG = LoggerFactory.getLogger(NestedIndexCreator.class);
	public static final String INDEX_NAME = "fundetestnestedindex";
	 ...
	 */
	public NestedIndexCreator(RestHighLevelClient client, RestClient restClient) {
		this.client = client;
	...
	private void generateEntry(int id, int q_user_id, String q_user_text, int q_user_someValue,
		...
		final Map<String, Object> jsonMapQUser = new HashMap<>();
		jsonMapQUser.put("q_user_id", q_user_id);
		jsonMapQUser.put("q_user_name", q_user_text);
		jsonMapQUser.put("q_user_value", q_user_someValue);

		final Map<String, Object> jsonMapAUser = new HashMap<>();
		jsonMapAUser.put("a_user_id", a_user_id);
		jsonMapAUser.put("a_user_name", a_user_text);
		jsonMapAUser.put("a_user_value", a_user_someValue);

		final Map<String, Object> jsonMapQuestion = new HashMap<>();
		jsonMapQuestion.put("question_id", question_id);
		jsonMapQuestion.put("question_text", question_text);
		jsonMapQuestion.put("question_value", question_someValue);

		final Map<String, Object> jsonMapAnswer = new HashMap<>();
		jsonMapAnswer.put("answer_id", answer_id);
		jsonMapAnswer.put("answer_text", answer_text);
		jsonMapAnswer.put("answer_value", answer_someValue);

		jsonMap.put("q_user", jsonMapQUser);
		jsonMap.put("a_user", jsonMapAUser);
		jsonMap.put("question", jsonMapQuestion);
		jsonMap.put("answer", jsonMapAnswer);
